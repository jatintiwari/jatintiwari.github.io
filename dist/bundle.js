    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 14, 16, 501);
    			add_location(span, file$1, 13, 12, 478);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "container contacts bg-blue svelte-1sph3ou");
    			add_location(div0, file$1, 11, 4, 386);
    			attr_dev(div1, "class", "section sticky-bottom border-dark svelte-1sph3ou");
