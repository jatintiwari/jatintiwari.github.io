var app = (function () {
    ...
    const file$5 = "src/js/Intro.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = text(".");
    			attr_dev(span0, "class", "hello-hand svelte-1o3onme");
    			add_location(span0, file$5, 11, 12, 348);
    			attr_dev(span1, "class", "hello-text svelte-1o3onme");
    			add_location(span1, file$5, 14, 20, 445);
    			add_location(span2, file$5, 13, 16, 418);
    			add_location(br, file$5, 16, 16, 536);
    			add_location(span3, file$5, 18, 20, 586);
    			attr_dev(a, "class", "cta");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "href", currentCompanyLink);
    			add_location(a, file$5, 19, 20, 638);
    			add_location(span4, file$5, 17, 16, 559);
    			add_location(span5, file$5, 12, 12, 395);
    			attr_dev(div0, "class", "about-me svelte-1o3onme");
    			add_location(div0, file$5, 10, 8, 313);
    			attr_dev(div1, "class", "introduction svelte-1o3onme");
    			add_location(div1, file$5, 9, 4, 278);
    			attr_dev(div2, "class", "section");
    			add_location(div2, file$5, 8, 0, 252);
    		},
    ...
    const file$4 = "src/js/Passion.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "mark");
    			add_location(span0, file$4, 3, 12, 106);
    			add_location(span1, file$4, 4, 12, 171);
    			add_location(span2, file$4, 5, 12, 283);
    			add_location(span3, file$4, 6, 12, 407);
    			add_location(section0, file$4, 2, 8, 84);
    			attr_dev(span4, "class", "highlight");
    			add_location(span4, file$4, 8, 65, 547);
    			add_location(p0, file$4, 8, 8, 490);
    			add_location(p1, file$4, 9, 8, 604);
    			attr_dev(p2, "class", "text-center");
    			add_location(p2, file$4, 13, 8, 887);
    			attr_dev(section1, "class", "container");
    			add_location(section1, file$4, 1, 4, 48);
    			attr_dev(section2, "class", "section passion-container");
    			add_location(section2, file$4, 0, 0, 0);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/js/Skills.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t34 = text(".");
    			add_location(p0, file$3, 9, 8, 349);
    			add_location(p1, file$3, 12, 8, 551);
    			attr_dev(span0, "class", "text-bold");
    			add_location(span0, file$3, 14, 32, 655);
    			attr_dev(span1, "class", "highlight");
    			add_location(span1, file$3, 15, 12, 738);
    			attr_dev(a0, "class", "cta");
    			attr_dev(a0, "href", "https://en.wikipedia.org/wiki/Furlenco");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$3, 15, 72, 798);
    			attr_dev(span2, "class", "highlight");
    			add_location(span2, file$3, 15, 220, 946);
    			attr_dev(span3, "class", "highlight");
    			add_location(span3, file$3, 15, 266, 992);
    			add_location(p2, file$3, 13, 8, 619);
    			attr_dev(span4, "class", "highlight");
    			add_location(span4, file$3, 18, 36, 1097);
    			attr_dev(span5, "class", "highlight");
    			add_location(span5, file$3, 19, 12, 1198);
    			attr_dev(a1, "class", "cta");
    			attr_dev(a1, "href", "https://en.wikipedia.org/wiki/Flipkart");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$3, 20, 12, 1268);
    			add_location(p3, file$3, 17, 8, 1057);
    			attr_dev(span6, "class", "text-italic");
    			add_location(span6, file$3, 24, 17, 1617);
    			add_location(p4, file$3, 23, 8, 1596);
    			attr_dev(span7, "class", "highlight");
    			add_location(span7, file$3, 28, 92, 1955);
    			attr_dev(span8, "class", "highlight");
    			add_location(span8, file$3, 29, 16, 2010);
    			add_location(p5, file$3, 27, 8, 1859);
    			attr_dev(section0, "class", "container");
    			add_location(section0, file$3, 8, 4, 313);
    			attr_dev(section1, "class", "section");
    			add_location(section1, file$3, 7, 0, 283);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/js/Contact.svelte";
    ...
    function create_if_block(ctx) {
    	let div1;
    	let div0;
    	let each_value = /*socialMediaKeys*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "container contacts bg-blue svelte-d3lop6");
    			add_location(div0, file$2, 16, 8, 486);
    			attr_dev(div1, "class", "section sticky-bottom border-dark svelte-d3lop6");
    			add_location(div1, file$2, 15, 4, 430);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*socialMedia, socialMediaKeys*/ 6) {
    				each_value = /*socialMediaKeys*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    ...
    // (18:12) {#each socialMediaKeys as key}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "cta");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "href", /*socialMedia*/ ctx[1][/*key*/ ctx[3]]);
    			add_location(a, file$2, 19, 20, 613);
    			add_location(span, file$2, 18, 16, 586);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:12) {#each socialMediaKeys as key}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	let if_block_anchor;
    	let if_block = /*mount*/ ctx[0] && create_if_block(ctx);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ socialMedia, socialMediaKeys, mount });

    	$$self.$inject_state = $$props => {
    		if ('mount' in $$props) $$invalidate(0, mount = $$props.mount);
    	};
    	...
    	$$invalidate(0, mount = false);
    	return [mount, socialMedia, socialMediaKeys];
    }
    ...
    /* src/js/Theme.svelte generated by Svelte v3.47.0 */

    const { console: console_1 } = globals;
    const file$1 = "src/js/Theme.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span1 = element("span");
    			span1.textContent = "🌚";
    			attr_dev(span0, "class", "theme-button sun svelte-1derer7");
    			add_location(span0, file$1, 26, 4, 831);
    			attr_dev(span1, "class", "theme-button moon svelte-1derer7");
    			add_location(span1, file$1, 27, 4, 905);
    			attr_dev(div, "class", "theme-container svelte-1derer7");
    			add_location(div, file$1, 25, 0, 797);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 8, 0, 245);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(theme, main, null);
    			append_dev(main, t0);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Intro, Passion, Skills, Contact, Theme });
    	return [];
    }
