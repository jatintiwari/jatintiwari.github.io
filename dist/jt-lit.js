            ...
            <ul>
                ${e.projects?e.projects.map(t=>d`
                              <li>
                                  ...
                                  <ul>
                                      ${t.responsibilities.map(i=>d`<li>${i}</li>`)}
                                  </ul>
                              </li>
