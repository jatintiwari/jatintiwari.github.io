var thoughts = (function () {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$a, 193, 1, 5904);
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$8, 64, 0, 1736);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "thoughts/src/js/Quotes.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$7, 7, 8, 188);
    			attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg0, "width", "24");
    			attr_dev(svg0, "height", "24");
    			attr_dev(svg0, "viewBox", "0 0 24 24");
    			attr_dev(svg0, "class", "rotate quotes svelte-1hmocav");
    			add_location(svg0, file$7, 6, 4, 74);
    			attr_dev(span0, "class", "center font-xxl text svelte-1hmocav");
    			add_location(span0, file$7, 11, 4, 453);
    			...
    			add_location(path1, file$7, 13, 8, 615);
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "width", "24");
    			attr_dev(svg1, "height", "24");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			attr_dev(svg1, "class", "quotes svelte-1hmocav");
    			add_location(svg1, file$7, 12, 4, 508);
    			attr_dev(span1, "class", "author svelte-1hmocav");
    			add_location(span1, file$7, 19, 8, 929);
    			attr_dev(div0, "class", "author-container svelte-1hmocav");
    			add_location(div0, file$7, 17, 4, 880);
    			attr_dev(div1, "class", "quote-container svelte-1hmocav");
    			add_location(div1, file$7, 5, 0, 40);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*by*/ 1) set_data_dev(t4, /*by*/ ctx[0]);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(default_slot, local);
    ...
    class Quotes extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { by: 0 });
    ...
    const file$6 = "thoughts/src/js/Intro.svelte";

    // (6:0) <Quotes by="Phil Knight">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(6:0) <Quotes by=\\\"Phil Knight\\\">",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			p = element("p");
    			p.textContent = "I am writing about the things which makes me curious.";
    			attr_dev(p, "class", "center");
    			add_location(p, file$6, 6, 0, 165);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			mount_component(quotes, target, anchor);
    			insert_dev(target, t0, anchor);
    		...
    		d: function destroy(detaching) {
    			destroy_component(quotes, detaching);
    			if (detaching) detach_dev(t0);
    ...
    const file$5 = "thoughts/src/js/footer.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(footer, file$5, 8, 0, 123);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "thoughts/src/js/Theme.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$4, 27, 4, 832);
    			attr_dev(span1, "class", "theme-button moon svelte-v1qxna");
    			add_location(span1, file$4, 28, 4, 906);
    			attr_dev(div, "class", "theme-container svelte-v1qxna");
    			add_location(div, file$4, 26, 0, 798);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "thoughts/src/js/Header.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			add_location(a, file$3, 15, 12, 308);
    			add_location(h3, file$3, 15, 8, 304);
    			attr_dev(div, "class", "header svelte-1wak258");
    			add_location(div, file$3, 14, 4, 275);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    ...
    /* thoughts/src/js/Image.svelte generated by Svelte v3.47.0 */

    const file$2 = "thoughts/src/js/Image.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(/*desc*/ ctx[1]);
    			attr_dev(p, "class", "desc svelte-ymbr5t");
    			add_location(p, file$2, 6, 15, 92);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    class Image extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { src: 0, desc: 1 });
    		...
    		if (/*desc*/ ctx[1] === undefined && !('desc' in props)) {
    			console.warn("<Image> was created without expected prop 'desc'");
    		}
    	}
...
<span class="token punctuation">&#125;</span></code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			t31 = space();
    			h41 = element("h4");
    			h41.textContent = "Above baseline image has a few diffs";
    			t33 = space();
    			ul2 = element("ul");
    			li7 = element("li");
    			...
    			t54 = space();
    			li13 = element("li");
    			t55 = text("If this request matches any of the listed urls in snapshots array in JSON it served with the custom response.");
    			ul3 = element("ul");
    			li12 = element("li");
    			li12.textContent = "It waits till the browser finishes its last network call for the page.";
    			t57 = space();
    			li16 = element("li");
    			t58 = text("Then if actions are included in the JSON then it executes.");
    			ul4 = element("ul");
    			li14 = element("li");
    			...
    			t62 = space();
    			li19 = element("li");
    			t63 = text("After running all the suites images comparison is done.");
    			ul5 = element("ul");
    			li17 = element("li");
    			...
    			add_location(h40, file$1, 5, 0, 63);
    			add_location(h2, file$1, 6, 0, 85);
    			add_location(hr, file$1, 7, 0, 132);
    			add_location(p0, file$1, 8, 0, 137);
    			add_location(p1, file$1, 9, 0, 296);
    			add_location(li0, file$1, 11, 0, 348);
    			add_location(li1, file$1, 12, 0, 371);
    			add_location(li2, file$1, 13, 0, 401);
    			add_location(ul0, file$1, 10, 0, 343);
    			add_location(p2, file$1, 15, 0, 437);
    			add_location(p3, file$1, 16, 0, 567);
    			add_location(h30, file$1, 20, 0, 1150);
    			add_location(li3, file$1, 22, 0, 1188);
    			add_location(li4, file$1, 23, 0, 1265);
    			add_location(li5, file$1, 24, 0, 1336);
    			add_location(li6, file$1, 25, 0, 1445);
    			add_location(ul1, file$1, 21, 0, 1183);
    			add_location(h41, file$1, 27, 0, 1519);
    			add_location(li7, file$1, 29, 0, 1570);
    			add_location(li8, file$1, 30, 0, 1616);
    			add_location(li9, file$1, 31, 0, 1685);
    			add_location(ul2, file$1, 28, 0, 1565);
    			add_location(h31, file$1, 33, 0, 1746);
    			add_location(p4, file$1, 34, 0, 1762);
    			add_location(p5, file$1, 35, 0, 2063);
    			add_location(h32, file$1, 36, 0, 2182);
    			attr_dev(pre, "class", "language-js");
    			add_location(pre, file$1, 37, 0, 2218);
    			add_location(h33, file$1, 63, 0, 6141);
    			add_location(li10, file$1, 65, 0, 6173);
    			add_location(li11, file$1, 66, 0, 6273);
    			add_location(li12, file$1, 68, 0, 6443);
    			add_location(ul3, file$1, 67, 113, 6438);
    			add_location(li13, file$1, 67, 0, 6325);
    			add_location(li14, file$1, 71, 0, 6601);
    			add_location(li15, file$1, 72, 0, 6679);
    			add_location(ul4, file$1, 70, 62, 6596);
    			add_location(li16, file$1, 70, 0, 6534);
    			add_location(li17, file$1, 75, 0, 6861);
    			add_location(li18, file$1, 76, 0, 6896);
    			add_location(ul5, file$1, 74, 59, 6856);
    			add_location(li19, file$1, 74, 0, 6797);
    			add_location(ul6, file$1, 64, 0, 6168);
    			add_location(h34, file$1, 79, 0, 6992);
    			add_location(li20, file$1, 82, 0, 7032);
    			add_location(li21, file$1, 83, 0, 7076);
    			add_location(ul7, file$1, 81, 12, 7027);
    			add_location(li22, file$1, 81, 0, 7015);
    			add_location(strong0, file$1, 85, 4, 7147);
    			add_location(li23, file$1, 86, 0, 7215);
    			add_location(ul8, file$1, 85, 67, 7210);
    			add_location(li24, file$1, 85, 0, 7143);
    			add_location(li25, file$1, 88, 0, 7308);
    			add_location(strong1, file$1, 89, 4, 7397);
    			add_location(li26, file$1, 89, 0, 7393);
    			add_location(ul9, file$1, 80, 0, 7010);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (34:24) <Link class="route" to={article.path}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:24) <Link class=\\\"route\\\" to={article.path}>",
    		ctx
    	});
    ...
    // (33:20) {#each articles as article}
    function create_each_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:20) {#each articles as article}",
    		ctx
    	});
    ...
    // (31:16) {#each months as [month, articles]}
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(b, file, 31, 23, 800);
    			add_location(p, file, 31, 20, 797);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, b);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(31:16) {#each months as [month, articles]}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 26, 12, 627);
    			attr_dev(div1, "class", "routes");
    			add_location(div1, file, 29, 12, 704);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    ...
    // (42:16) {#each articles as article}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:16) {#each articles as article}",
    		ctx
    	});
    ...
    // (41:12) {#each months as [_, articles]}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:12) {#each months as [_, articles]}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 38, 8, 1047);
    		},
    		m: function mount(target, anchor) {
    			mount_component(route, target, anchor);
    			insert_dev(target, t0, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "app");
    			add_location(div, file, 23, 0, 562);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
