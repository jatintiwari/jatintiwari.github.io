...
<span class="token punctuation">&#125;</span></code>` + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			t58 = space();
    			li13 = element("li");
    			t59 = text("If this request matches any of the listed urls in snapshots array in JSON it served with the custom response.");
    			ul3 = element("ul");
    			li12 = element("li");
    			li12.textContent = "It waits till the browser finishes its last network call for the page.";
    			t61 = space();
    			li16 = element("li");
    			t62 = text("Then if actions are included in the JSON then it executes.");
    			ul4 = element("ul");
    			li14 = element("li");
