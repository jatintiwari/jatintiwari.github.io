var thoughts = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 193, 1, 5904);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$6, 64, 0, 1736);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "thoughts/src/js/Quotes.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$5, 7, 8, 188);
    			attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg0, "width", "24");
    			attr_dev(svg0, "height", "24");
    			attr_dev(svg0, "viewBox", "0 0 24 24");
    			attr_dev(svg0, "class", "rotate quotes svelte-uxkbuk");
    			add_location(svg0, file$5, 6, 4, 74);
    			attr_dev(span0, "class", "center font-xxl text svelte-uxkbuk");
    			add_location(span0, file$5, 11, 4, 453);
    			...
    			add_location(path1, file$5, 13, 8, 615);
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "width", "24");
    			attr_dev(svg1, "height", "24");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			attr_dev(svg1, "class", "quotes svelte-uxkbuk");
    			add_location(svg1, file$5, 12, 4, 508);
    			attr_dev(span1, "class", "author svelte-uxkbuk");
    			add_location(span1, file$5, 19, 8, 929);
    			attr_dev(div0, "class", "author-container svelte-uxkbuk");
    			add_location(div0, file$5, 17, 4, 880);
    			attr_dev(div1, "class", "quote-container svelte-uxkbuk");
    			add_location(div1, file$5, 5, 0, 40);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Quotes extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { by: 0 });
    ...
    const file$4 = "thoughts/src/js/Intro.svelte";
    ...
    const file$3 = "thoughts/src/js/footer.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(footer, file$3, 8, 0, 123);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(/*desc*/ ctx[1]);
    			attr_dev(p, "class", "desc svelte-1lrnz6g");
...
<span class="token punctuation">&#125;</span></code>` + "";
    ...
    // (32:24) <Link class="route" to={article.path}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:24) <Link class=\\\"route\\\" to={article.path}>",
    		ctx
    	});
    ...
    // (31:20) {#each articles as article}
    function create_each_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(31:20) {#each articles as article}",
    		ctx
    	});
    ...
    // (29:16) {#each months as [month, articles]}
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:16) {#each months as [month, articles]}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 24, 12, 564);
    			attr_dev(div1, "class", "routes");
    			add_location(div1, file, 27, 12, 641);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    ...
    // (39:16) {#each articles as article}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:16) {#each articles as article}",
    		ctx
    	});
    ...
    // (38:12) {#each months as [_, articles]}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:12) {#each months as [_, articles]}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 36, 8, 977);
    		},
    		m: function mount(target, anchor) {
    			mount_component(route, target, anchor);
    			insert_dev(target, t, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "app");
    			add_location(div, file, 21, 0, 499);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
